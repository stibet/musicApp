...
export const t = {
  tr: {
    ...
    baslamakIcin: '🎤 Başlamak için butona bas', pest: 'pest', dogru2: 'doğru', tiz: 'tiz',
    komaYukarida: 'koma tiz', komaAsagida: 'koma pest', makami: 'Makamı',
    enstrumanlar: '🎸 Enstrüman Çal', enstrumanSec: 'Bir enstrüman seç ve çalmaya başla!',
    analizOzeti: 'Analiz Özeti', isabet: 'İsabet', ortalamaSapma: 'Ortalama Sapma',
    baskinPerdeler: 'Baskın Perdeler', seansSifirla: 'Seansı Sıfırla', webDahaIyi: 'Web sürümünde pitch analizi daha doğru çalışır.',
    deneyselNative: 'Native mikrofon analizi şu an deneysel; koma duyarlılığı için web önerilir.', durum: 'Durum', hedef: 'Hedef',
  },
  en: {
    ...
    baslamakIcin: '🎤 Press button to start', pest: 'flat', dogru2: 'correct', tiz: 'sharp',
    komaYukarida: 'commas sharp', komaAsagida: 'commas flat', makami: 'Maqam',
    enstrumanlar: '🎸 Play Instrument', enstrumanSec: 'Select an instrument and start playing!',
    analizOzeti: 'Analysis Summary', isabet: 'Accuracy', ortalamaSapma: 'Average Deviation',
    baskinPerdeler: 'Dominant Notes', seansSifirla: 'Reset Session', webDahaIyi: 'Pitch analysis is more accurate on the web build.',
    deneyselNative: 'Native microphone analysis is experimental for now; use web for comma-sensitive analysis.', durum: 'Status', hedef: 'Target',
  },
};
